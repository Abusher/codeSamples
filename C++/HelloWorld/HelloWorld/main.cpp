...
int main()
{
	...
	{
		std::cout << "Failes to initialize glad" << std::endl;
		return -1;
	}
	...
	Shader lampShader("Shaders/LampVertex.txt", "Shaders/LampFragment.txt");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		ourShader.setVec3("light.diffuse", diffuseColor); // darken the light a bit to fit the scene
